...
from ..service_decorators import service_operation_safe, file_processing_safe
...
class RouterService:
    ...
    @file_processing_safe("RouterService配置加载失败", return_value={"intents": {}, "routing": {}, "settings": {}})
    ...
    @service_operation_safe("消息路由失败", return_value={'success': False, 'error': '路由失败', 'route_type': 'error'})
